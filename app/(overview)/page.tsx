...
export default function Home() {
  return (
    <main className="relative flex flex-col items-center justify-between">
      <section className="relative flex min-h-screen flex-col items-center text-center text-white px-5 pt-28 md:pt-24 bg-contain bg-no-repeat md:bg-cover bg-bottom md:bg-center bg-purple-800" style={{ backgroundImage: "url('/bg.png')" }}>
